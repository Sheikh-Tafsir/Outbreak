      ...
      while (window.isOpen()){
            ...
            if(x==0){
                  ...
                  //while(1){
                        ...
                        if(men==1)start.setFillColor(sf::Color::Yellow);
                        ...
                        exit.setFont( myFont );
                        exit.setString("EXIT");
                        if(men==2)exit.setFillColor(sf::Color::Yellow);
                        ...
                        if (Keyboard::isKeyPressed(Keyboard::S)){goto sound;}
                        else if (Keyboard::isKeyPressed(Keyboard::B)){goto theme;}
                        else if (Keyboard::isKeyPressed(Keyboard::P)){goto set1;}

                        if(men==1){
                              if (Keyboard::isKeyPressed(Keyboard::Down))men=2;
                              else if (Keyboard::isKeyPressed(Keyboard::Enter)){
                                    x=22;
                                    goto game;
                              }
                              ...
                              if (Keyboard::isKeyPressed(Keyboard::Up))men=1;
                        ...
                        if (Keyboard::isKeyPressed(Keyboard::Up)){goto start;}
                        else if (Keyboard::isKeyPressed(Keyboard::S)){goto sound;}
                        else if (Keyboard::isKeyPressed(Keyboard::B)){goto theme;}
                        else if (Keyboard::isKeyPressed(Keyboard::P)){goto set1;}
                        else if (Keyboard::isKeyPressed(Keyboard::Enter))return 0;
                  }
                        ...
                        if(sn==1)soundon.setFillColor(sf::Color::Yellow);
                        ...
                        if(sn==0)soundoff.setFillColor(sf::Color::Yellow);
                        ...
                        else if (Keyboard::isKeyPressed(Keyboard::Escape))goto setting;
                  }
                        ...
                        theme.setFont( myFont );
                             if(xn==0)theme.setString("         'WHITEBACK'\n\n  BATBACK       DEADBACK \n\n           SUPBACK");
                        else if(xn==1)theme.setString("          WHITEBACK \n\n 'BATBACK'      DEADBACK \n\n           SUPBACK");
                        else if(xn==2)theme.setString("          WHITEBACK \n\n  BATBACK      'DEADBACK'\n\n           SUPBACK");
                        else if(xn==3)theme.setString("          WHITEBACK \n\n  BATBACK       DEADBACK \n\n          'SUPBACK'");
                        ...
                        if (Keyboard::isKeyPressed(Keyboard::Down)){goto set2;}
                        else if (Keyboard::isKeyPressed(Keyboard::Enter)){goto population;}
                        else if (Keyboard::isKeyPressed(Keyboard::Escape)){goto setting;}
                  }
                        ...
                        if (Keyboard::isKeyPressed(Keyboard::Up)){goto set1;}
                        else if (Keyboard::isKeyPressed(Keyboard::Enter)){goto mobili;}
                        else if (Keyboard::isKeyPressed(Keyboard::Escape)){goto setting;}
                  }
                        ...
                        sf::Text population;
                        population.setFont( myFont );
                             if(pp==0)population.setString("         '500'\n\n  400           300 \n\n           200 ");
                        else if(pp==1)population.setString("          500 \n\n '400'          300 \n\n           200 ");
                        else if(pp==2)population.setString("          500 \n\n  400          '300'\n\n           200 ");
                        else if(pp==3)population.setString("          500 \n\n  400           300 \n\n          '200'");
                        population.setFillColor(sf::Color::Yellow);
                        population.setStyle(sf::Text::Regular);
                        population.setCharacterSize(30);
                        ...
                        mobili.setFont( myFont );
                             if(mb==0)mobili.setString("            '100%' \n\n    70%             50%  \n\n              10%  ");
                        else if(mb==1)mobili.setString("             100%  \n\n   '70%'            50%  \n\n              10%  ");
                        else if(mb==2)mobili.setString("             100%  \n\n    70%            '50%' \n\n              10%  ");
                        else if(mb==3)mobili.setString("             100%  \n\n    70%             50%  \n\n             '10%' ");
                  ...
                  x=9;
                        ...
                        if(st==1)sound.setFillColor(sf::Color::Yellow);
                        ...
                        if(st==2)bground.setFillColor(sf::Color::Yellow);
                        else bground.setFillColor(sf::Color::White);
                        ...
                        if(st==3)pre.setFillColor(sf::Color::Yellow);
                        else pre.setFillColor(sf::Color::White);
                        ...
                        if(st==1){
                              if (Keyboard::isKeyPressed(Keyboard::Down))st=2;
                              else if (Keyboard::isKeyPressed(Keyboard::Enter))goto sound;
                        }
                        else if(st==2){
                              if (Keyboard::isKeyPressed(Keyboard::Down))st=3;
                              else if (Keyboard::isKeyPressed(Keyboard::Up))st=1;
                              else if (Keyboard::isKeyPressed(Keyboard::Enter))goto theme;
                        }
                        else if(st==3){
                              if (Keyboard::isKeyPressed(Keyboard::Up))st=2;
                              else if (Keyboard::isKeyPressed(Keyboard::Enter))goto set1;
                        }
		...
		for(i=0; i<n; i++){
			...
			if(per[i].status == Healthy){
				...
				n_H++;
			      ...
			      else if(per[i].recovery_time>=14.8)sBall[i]=Sprite(t9);
			      else if(per[i].recovery_time>=14.6)sBall[i]=Sprite(t5);
			      else if(per[i].recovery_time==14.4)sBall[i]=Sprite(t9);

			      else sBall[i]=Sprite(t3);
				n_I++;
			}
			      ...
			      else if(per[i].recovery_time>=0.6)sBall[i]=Sprite(t5);
			      else if(per[i].recovery_time>=0.4)sBall[i]=Sprite(t6);
			      else sBall[i]=Sprite(t4);
				n_R++;
			}
			...
			if(per[i].status == Healthy){
				...
				for(j=0; j<n; j++){
				      ...
				      if((i!=j) && (per[j].status==Infected) && mob[i].m==1 && mob[j].m==1){
                                     ...
                                     if(loc[i].infect_other(loc[j]))per[i].status = Infected;//check if person can be infected
				      }
				}
			}
